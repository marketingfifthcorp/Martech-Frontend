    ...
    >
      ...
      {activeTab === "strategy" && (
        <div className="sa">
          ...
          {portalClientId && (strategyApproved || strategy?.approvals?.some((a: any) => a.action === "APPROVED" && a.userId === user?.id)) ? (
          ...
          {portalClientId && <div className="g2">
            ...
            <div>
              {!strategyApproved && !strategy?.approvals?.some((a: any) => a.action === "APPROVED" && a.userId === user?.id) && strategy && (
                <div className="cd" style={{ marginBottom: 12 }}>
              ...
              <div className="cd">
                ...
                {[{ label: "Strategy generated by AI", done: true }, { label: "Internal review by agency", done: true }, { label: "Client approval (you)", act: !strategyApproved && !strategy?.approvals?.some((a: any) => a.action === "APPROVED" && a.userId === user?.id) }, { label: "Calendar generation unlocked", act: false }].map((a, i) => (
